...
const Header = () => {
  return (
    <header className="border-b border-slate-300 shadow-md">
      <div className="max-w-[1000px] mx-auto flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8">
        ...
        <button className="px-4 py-2 text-xs border rounded hover:bg-gray-100 transition sm:self-start">
          Theme
        </button>
      </div>
    </header>
