...
const Hero = () => {
  ...
  return (
    ...
    >
      <div
        className={`max-w-[900px] mx-auto py-4 px-4 sm:px-6 lg:px-8 flex flex-col gap-6 transition-colors duration-300 ${
      ...
      >
        ...
        <small
          className={`block mt-2 italic text-base transition-colors duration-300 ${
